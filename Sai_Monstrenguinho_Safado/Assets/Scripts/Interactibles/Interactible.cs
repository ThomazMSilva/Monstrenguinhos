...
namespace Assets.Scripts.Interactibles
{
    public class Interactible : MonoBehaviour
    {
        ...
        [SerializeField] protected bool triggersAnimation = true;

        public virtual void Interact(object sender = null)
        {
            UnityEngine.Debug.LogWarning($"Interagivel {gameObject.name} nao contem implementacao para \'Interact()\'");
        }
